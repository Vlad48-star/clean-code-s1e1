...
var createNewTaskElement=function(taskString){
  ...
  listItem.className = 'item list-style-none';
  //input (checkbox)
  ...
  label.className="item-label task";
  //Each elements, needs appending
  checkBox.type="checkbox";
  checkBox.className = 'item_checkbox outline_none';
  editInput.type="text";
  editInput.className="input_text text_todo outline_none task";

  editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
  editButton.className="button_edit outline_none";

  deleteButton.className="button_delete outline_none";
